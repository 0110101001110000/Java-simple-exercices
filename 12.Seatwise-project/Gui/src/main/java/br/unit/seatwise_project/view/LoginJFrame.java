...
public class LoginJFrame extends JFrame {
    ...
    private final Logger logger = LoggerUtils.getLogger(LoginJFrame.class);
    ...
    public LoginJFrame() throws HeadlessException {
        ...
        logger.info("Inicializando frame de login");
        ...
        signButton.setPreferredSize(new Dimension(156, 18));
        signButton.setText("Não Tenho Conta");
        signButton.setForeground(Color.LIGHT_GRAY);
        signButton.setHorizontalAlignment(JLabel.CENTER);
        signButton.setFont(new Font(null, Font.BOLD, 14));
        ...
        submitButton.addActionListener(new LoginController.ClickActionHandler(this, emailField, passwordField, submitButton));
        signButton.addMouseListener(
            new MouseAdapter() {
                @Override
                public void mouseClicked(MouseEvent e) {
                    LoginJFrame.super.dispose();
                ...
                public void mouseEntered(MouseEvent e) {
                    signButton.setForeground(new Color(0, 135, 217));
                }
        ...
        logger.info("Adicionando componentes no frame de login");
        ...
        contentSectionPanel.add(signButton);
