...
for i in range(len(data)):
    try:
        ...
        if (response.status_code == 201) | (response.status_code == 200):
            print(f"Foi adicionado uma nova página: {data[i]['url']};")
        else:
            print(
